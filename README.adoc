...
link:https://api.securityscorecards.dev/projects/github.com/updatecli/updatecli[image:https://api.securityscorecards.dev/projects/github.com/google/osv-scanner/badge[OpenSSF Scorecard]]
