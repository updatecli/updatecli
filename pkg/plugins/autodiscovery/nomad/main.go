...
/*
"nomad" defines the specification for the Nomad autodiscovery crawler.
It searches Nomad job files and generates manifests to update the container images used by their Docker driver tasks.
*/
type Spec struct {
	...
	// "rootdir" defines the directory where the crawler starts searching for Nomad files.
	//
	// default:
	...
	// "filematch" defines the file name patterns the crawler searches for.
	//
