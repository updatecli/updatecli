...
var data = []DataSet{
	...
	},
	{
		...
		expectedCondition: false,
		expectedHostname:  "ghcr.io",
		expectedError:     errors.New("ghcr.io/olblak/updatecli:donotexist - manifest unknown"),
		expectedImage:     "olblak/updatecli",
		expectedDigest:    "",
	},
	{
		...
		expectedCondition: false,
		expectedHostname:  "ghcr.io",
		expectedError:     errors.New("ghcr.io/donotexist/donotexist:donotexist - manifest unknown"),
