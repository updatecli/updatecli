...
func TestTarget(t *testing.T) {
	...
	for _, tt := range testData {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			err = c.Target(context.Background(), tt.sourceInput, nil, pathresolver.Resolver{}, true, &gotResult)
...
func TestTargetDaselV3Write(t *testing.T) {
	...
	err = c.Target(context.Background(), "Tom", nil, pathresolver.Resolver{}, false, &gotResult)
	require.NoError(t, err)
