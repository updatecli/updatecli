...
func TestFile_TargetMultiples(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotErr := f.Target(context.Background(), tt.inputSourceValue, mockSCM, pathresolver.New(mockSCM, ""), tt.dryRun, &gotResultTarget)
...
func TestFile_TargetFromSCM(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotErr := f.Target(context.Background(), tt.inputSourceValue, tt.scm, pathresolver.New(tt.scm, ""), tt.dryRun, &gotResultTarget)
...
jdk_version = "11.0.12"`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotResultTarget := result.Target{}
			err := f.Target(context.Background(), tt.inputSourceValue, nil, pathresolver.Resolver{}, true, &gotResultTarget) // dry run
