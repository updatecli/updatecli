...
func (g Stash) Target(ctx context.Context, source string, scm scm.ScmHandler, pathResolver pathresolver.Resolver, dryRun bool, resultTarget result.Target) error {
	if len(g.spec.Tag) == 0 {
		g.spec.Tag = source
	}
