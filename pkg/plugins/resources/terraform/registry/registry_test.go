...
func TestRegistryAddressAPI(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedResult: "https://registry.terraform.io/v1/providers/hashicorp/kubernetes/versions",
		...
		},
		{
			...
			expectedResult: "https://registry.terraform.io/v1/modules/terraform-aws-modules/vpc/aws/versions",
			expectedUrl:    "https://registry.terraform.io/.well-known/terraform.json",
			mockedHttpBody: `{"modules.v1":"/v1/modules/","providers.v1":"/v1/providers/"}`,
		},
		{
		...
		},
		{
			...
			expectedResult: "https://gitlab.example.com/api/v4/packages/terraform/modules/v1/updatecli/namespace/kubernetes/versions",
